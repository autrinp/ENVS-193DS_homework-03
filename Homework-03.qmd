...
By doing the alternative test( The Spearman rank coorelation) the results would be very similar and would both reject the null hypothesis that the two variables have no relation to each other. We found a moderate relationship between soil salinty(mS/cm) and pickleweed biomass(g)(Spearman's r = 0.59, t = 824, p = 0.003, ⍺ = 0.5).
